...
const PROJECT_ID = process.env.EXPO_PUBLIC_FIREBASE_PROJECT_ID || 'b-tracker-28';
const FIREBASE_API_KEY = process.env.EXPO_PUBLIC_FIREBASE_API_KEY || 'AIzaSyCgu5ASIVjSWKJmOEXP5b1uHI8D1_sdNQo';
