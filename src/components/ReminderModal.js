...
const styles = StyleSheet.create({
  ...
  currencyText: { color: colors.accentTeal, fontFamily: 'Inter_700Bold' },
  ...
  pillTextActive: { color: colors.accentTeal, fontFamily: 'Inter_700Bold' },
  ...
  repeatTextActive: { color: '#fff', fontFamily: 'Inter_700Bold' },
