...
const styles = StyleSheet.create({
  ...
  reminderTitle: { fontSize: 16, fontWeight: '700', color: colors.text, marginBottom: 4 },
  dueRow: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  dueDate: { fontSize: 12, color: colors.textMuted },
  amount: { fontSize: 16, fontWeight: '800', color: colors.text, marginBottom: 4 },
  delBtn: { padding: 5 },

  empty: { flex: 1, alignItems: 'center', justifyContent: 'center', marginTop: 100 },
  emptyText: { color: colors.textMuted, marginTop: 15, fontWeight: '600' },
  emptyAdd: { marginTop: 20, backgroundColor: colors.primary + '15', padding: 12, borderRadius: 12 },
  emptyAddText: { color: colors.primary, fontWeight: '700' },
  ...
  pickerVal: { color: colors.text, fontWeight: '600' },
  ...
  optText: { fontSize: 12, color: colors.textSecondary, fontWeight: '600' },
